...
-- stops describing what is actually in the building. Captured and flagged to
-- the manager instead.
...
alter table public.pets add constraint pets_size_band_check
...
alter table public.pets add constraint pets_diet_type_check
...
alter table public.pets add constraint pets_height_check
...
alter table public.pets add constraint pets_restraints_check
