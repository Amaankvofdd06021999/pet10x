...
describe("parseAmountToCents", () => {
  ...
  it.each([
    ...
    ["2 5 0", "internal spaces are holes in a number, not formatting"],
    ["1 000.00", "a space group with a decimal part, under the ceiling either way"],
    ["$2 50", "a leading symbol does not license spaces after the digits start"],
